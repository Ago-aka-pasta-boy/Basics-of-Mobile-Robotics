...
img_thymio = cv.imread('images/thymio.png', cv.IMREAD_UNCHANGED)
img_eiffel = cv.imread('images/eiffel_tower.png', cv.IMREAD_UNCHANGED)
img_arch = cv.imread('images/arch.png', cv.IMREAD_UNCHANGED)
